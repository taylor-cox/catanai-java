...
import numpy as np
from ai.ml.base_agent import Base_Agent
from ai.ml.exploration_strategies.epsilon_greedy_exploration import Epsilon_Greedy_Exploration
from ai.ml.utilities.replay_buffer import Replay_Buffer
...
class DQN(Base_Agent):
    ...
    def pick_action(self, state=None):
        ...
        if isinstance(state, np.int64) or isinstance(state, int): state = np.array([state]) # type: ignore
